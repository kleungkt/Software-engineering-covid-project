...
public class World extends Region {
    ...
    private static final String                          HIRES_PROPERTIES = "comp3111/covid/c3worldmap/hires.properties";
    private static final String                          LORES_PROPERTIES = "comp3111/covid/c3worldmap/lores.properties";
    private static final double                          PREFERRED_WIDTH  = 1009;//719; //original: 1009
    private static final double                          PREFERRED_HEIGHT = 665;//406; //original: 665
    ...
    public World(final Resolution RESOLUTION) {
        ...
        selectedCountry      = new ObjectPropertyBase<C3Country>() {
            @Override protected void invalidated() {}
            @Override public Object getBean() { return World.this; }
    ...
    private void initGraphics() {
        ...
        countryPaths.forEach((name, pathList) -> {
            C3Country country = C3Country.valueOf(name);
    ...
    public C3Country getSelectedCountry() { return selectedCountry.get(); }
    public void setSelectedCountry(final C3Country COUNTRY) { selectedCountry.set(COUNTRY); }
    public ObjectProperty<C3Country> selectedCountryProperty() { return selectedCountry; }
    ...
    public void zoomToCountry(final C3Country COUNTRY) {
    ...
    private double[] getBounds(final C3Country... COUNTRIES) { return getBounds(Arrays.asList(COUNTRIES)); }
    private double[] getBounds(final List<C3Country> COUNTRIES) {
        double upperLeftX  = PREFERRED_WIDTH;
        double upperLeftY  = PREFERRED_HEIGHT;
        double lowerRightX = 0;
        double lowerRightY = 0;
        for (C3Country country : COUNTRIES) {
    ...
    private void handleMouseEvent(final MouseEvent EVENT, final EventHandler<MouseEvent> HANDLER) {
        ...
        final C3Country           COUNTRY      = C3Country.valueOf(COUNTRY_NAME);
    ...
    private void setCountryFillAndStroke(final C3Country COUNTRY, final Color FILL, final Color STROKE) {
        List<CountryPath> paths = countryPaths.get(COUNTRY.getName());
